...
def render_results(draft, review):
    ...
    with c1:
        ...
        <div class="result-card">
            ...
            <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.06); text-align: center; font-size: 0.8rem; color: #94a3b8; font-style: italic;">
                this result is generated by <span style="color: #a5b4fc; font-weight: 600;">{draft.provider}</span> model <span style="font-size: 0.7rem; color: #64748b;">({draft.model_name})</span>
            </div>
        </div>
        """, unsafe_allow_html=True)
